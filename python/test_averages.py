...
class TestAvg:
    ...
    def calc_avg(self):
        ...
        self.avg.set(str(self.average) + ' (' + self.getLetterGrade() + ')')
    
    # The getLetterGrade method returns a letter grade based on the score passed to the function.
    def getLetterGrade(self):
        if (self.average >= 93):
            ...
            return 'B+'
        elif (self.average >= 83):
            return 'B'
        elif (self.average >= 80):
            return 'B-'
        elif (self.average >= 77):
            return 'C-'
        elif (self.average >= 73):
            return 'C'
